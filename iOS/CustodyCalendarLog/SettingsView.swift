...
struct SettingsView: View {
    ...
    @AppStorage("custodylog_notifyEnabled") private var notifyEnabled = true
    @AppStorage("custodylog_iCloudSyncEnabled") private var iCloudSyncEnabled = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/custodylog-app/privacy.html")!)
                    Text("Version 1.0")
